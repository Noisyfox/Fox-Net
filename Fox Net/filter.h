...
#define FILTER_FRIENDLY_NAME        L"FoxNet NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{c87850cc-56ad-44d3-8652-6c8eb00bc5e2}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"FoxNet"

//
// The filter needs to handle IOCTLs
//
#define LINKNAME_STRING             L"\\DosDevices\\FoxNet"
#define NTDEVICE_STRING             L"\\Device\\FoxNet"
...
NDIS_STATUS
FoxNetRegisterDevice(
    VOID
    );

_IRQL_requires_max_(PASSIVE_LEVEL)
VOID
FoxNetDeregisterDevice(
    VOID
    );

DRIVER_DISPATCH FoxNetDispatch;

DRIVER_DISPATCH FoxNetDeviceIoControl;
